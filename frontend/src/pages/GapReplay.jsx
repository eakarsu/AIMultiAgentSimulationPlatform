...
// Replay
// Replay UI (route exists but limited frontend)
...
export default function GapReplay() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-replay', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Replay</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Replay UI (route exists but limited frontend)</p>
