...
// Agentic
// Agentic simulation orchestrator running scenarios autonomously and reporting insights
...
export default function GapAgentic() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic simulation orchestrator running scenarios autonomously and reporting insights</p>
