...
// Scenario
// Scenario library with benchmarking and result diffing

export default function GapScenario() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-scenario', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Scenario</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Scenario library with benchmarking and result diffing</p>
