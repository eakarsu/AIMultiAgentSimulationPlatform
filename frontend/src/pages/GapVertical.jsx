...
// Vertical
// Vertical packs: supply chain, market dynamics, disease spread, traffic
...
export default function GapVertical() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Vertical packs: supply chain, market dynamics, disease spread, traffic</p>
