...
// Real Time
// Real-time agent behavior steering with mid-simulation parameter adjustment
...
export default function GapRealTime() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Real-time agent behavior steering with mid-simulation parameter adjustment</p>
