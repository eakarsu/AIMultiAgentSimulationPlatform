...
// Multi Agent
// Multi-agent negotiation agent for consensus / deal-making scenarios

export default function GapMultiAgent() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-multi-agent', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Multi Agent</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Multi-agent negotiation agent for consensus / deal-making scenarios</p>
