...
// Websocket
// WebSocket streaming for live runs

export default function GapWebsocket() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-websocket', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Websocket</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>WebSocket streaming for live runs</p>
